...
public class UserCollectController {
    ...
    public CommonResult<String> userCollect(@PathVariable Integer id) {
    ...
    public CommonResult<String> userCancelCollect(@PathVariable Integer id) {
    ...
    public CommonResult<String> userBatchCancelCollect(@RequestBody CancelCollectRequest request) {
    ...
    @ApiOperation(value = "用户入会列表")
    @RequestMapping(value = "/user/add/merchant/list", method = RequestMethod.GET)
    public CommonResult<CommonPage<MerchantCollectResponse>> findUserAddMerchantList(@Validated PageParamRequest pageParamRequest) {
        return CommonResult.success(CommonPage.restPage(merchantMemberService.findUserAddMerchantList(pageParamRequest)));
    }
}
