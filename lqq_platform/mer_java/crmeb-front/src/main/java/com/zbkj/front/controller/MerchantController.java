...
public class MerchantController {
    ...
    public CommonResult<CommonPage<MerchantSearchResponse>> getStreet(@ModelAttribute MerchantStreetRequest request) {
        return CommonResult.success(CommonPage.restPage(merchantService.getStreet(request)));
    }
    ...
    @ApiOperation(value = "获取商户底部导航信息")
    @RequestMapping(value = "/get/bottom/navigation/{merId}", method = RequestMethod.GET)
    public CommonResult<List<BottomNavigationVo>> getBottomNavigation(@PathVariable("merId") Integer merId) {
        return CommonResult.success(frontMerchantService.getBottomNavigationInfo(merId));
    }
}
