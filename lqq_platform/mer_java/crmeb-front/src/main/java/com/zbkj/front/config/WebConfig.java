...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(frontTokenInterceptor()).
                ...
                excludePathPatterns("/api/front/circle/**").

                excludePathPatterns("/api/front/coupon/merchant/member/list/ids").
                excludePathPatterns("/api/front/merchant/member/level/list/**").

                excludePathPatterns("/api/front/merchant/shopping/credits/**").
                excludePathPatterns("/api/front/merchant/get/bottom/navigation/**").
