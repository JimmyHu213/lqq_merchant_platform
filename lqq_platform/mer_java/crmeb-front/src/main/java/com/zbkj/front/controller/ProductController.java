...
public class ProductController {
    ...
    public CommonResult<CommonPage<ProductCommonResponse>> getMerchantProList(@ModelAttribute @Validated MerchantProductSearchRequest request) {
        return CommonResult.success(CommonPage.restPage(productService.getMerchantProList(request)));
    }
    ...
    @ApiOperation(value = "预约商品详情——规格数据")
    @RequestMapping(value = "/detail/reservation/{id}", method = RequestMethod.GET)
    public CommonResult<ReservationProductAttrInfoResponse> getReservationProductAttrInfo(@PathVariable(value = "id") Integer id) {
        return CommonResult.success(productService.getReservationProductAttrInfo(id));
    }

    @ApiOperation(value = "预约商品可预约日期——通过年月")
    @RequestMapping(value = "/can/reservation/date", method = RequestMethod.GET)
    public CommonResult<List<ReservationDateResponse>> findCanReservationDateList(@ModelAttribute @Validated CanReservationDateRequest request) {
        return CommonResult.success(productService.findCanReservationDateList(request));
    }

    @ApiOperation(value = "预约商品可预约时段——通过日期")
    @RequestMapping(value = "/can/reservation/time/slot", method = RequestMethod.GET)
    public CommonResult<List<ReservationTimeSlotResponse>> findCanReservationTimeSlotList(@ModelAttribute @Validated CanReservationTimeSlotRequest request) {
        return CommonResult.success(productService.findCanReservationTimeSlotList(request));
    }
}
