...
public class AgreementController {
    ...
    @ApiOperation(value = "商户会员开卡协议 详情")
    @RequestMapping(value = "/member/card/open/info/{merId}", method = RequestMethod.GET)
    public CommonResult<String> merchantMemberCardOpenInfo(@PathVariable("merId") Integer merId) {
        return CommonResult.success(systemConfigService.getAgreementByKey(SysConfigConstants.MERCHANT_MEMBER_CARD_OPEN_AGREEMENT, merId));
    }
