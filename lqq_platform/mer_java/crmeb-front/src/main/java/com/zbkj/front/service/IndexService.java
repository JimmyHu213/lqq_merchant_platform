...
public interface IndexService{
     ...
     * 首页商品组件列表
     */
    List<ProductCommonResponse> findIndexProductListComponent(IndexProductComponentRequest request);

    /**
     * 首页店铺列表
     */
    List<IndexMerchantResponse> findIndexMerchantList(IndexMerchantRequest request);
}
