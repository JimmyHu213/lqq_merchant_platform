...
public class IndexController {
    ...
    @ApiOperation(value = "首页商品列表组件")
    @RequestMapping(value = "/product/list/component", method = RequestMethod.GET)
    public CommonResult<List<ProductCommonResponse>> getProductListComponent(@ModelAttribute @Validated IndexProductComponentRequest request) {
        return CommonResult.success(indexService.findIndexProductListComponent(request));
    }
    ...
    public CommonResult<CommonPage<IndexMerchantResponse>> findIndexMerchantList(@ModelAttribute @Validated IndexMerchantRequest request) {
        return CommonResult.success(CommonPage.restPage(indexService.findIndexMerchantList(request)));
    }
