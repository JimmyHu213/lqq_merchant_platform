...
public interface FrontProductService {
     ...
     * @return List
     */
    PageInfo<ProductFrontResponse> getList(ProductFrontSearchRequest request);
     ...
     * @return List
     */
    PageInfo<ProductCommonResponse> getMerchantProList(MerchantProductSearchRequest request);
     ...
     * @param id 预约商品ID
     */
    ReservationProductAttrInfoResponse getReservationProductAttrInfo(Integer id);

    /**
     * 预约商品可预约日期——通过年月
     */
    List<ReservationDateResponse> findCanReservationDateList(CanReservationDateRequest request);

    /**
     * 预约商品可预约时段——通过日期
     */
    List<ReservationTimeSlotResponse> findCanReservationTimeSlotList(CanReservationTimeSlotRequest request);
