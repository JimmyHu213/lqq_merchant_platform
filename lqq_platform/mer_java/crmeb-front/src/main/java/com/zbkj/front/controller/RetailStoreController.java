...
public class RetailStoreController {
    ...
    public CommonResult<UserClosingApplyResponse> closingApply(@RequestBody @Validated UserClosingApplyRequest request) {
        return CommonResult.success(retailStoreService.userClosingApply(request));
    }
