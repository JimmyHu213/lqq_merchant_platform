...
@ApiModel(value = "FrontWorkOrderPageDataResponse", description = "移动端工单分页列表数据响应对象")
public class FrontWorkOrderPageDataResponse implements Serializable {

    private static final long serialVersionUID = -8369227292025050533L;
