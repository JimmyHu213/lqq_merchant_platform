...
public class OrderAdminDetailResponse implements Serializable {
    ...
    @ApiModelProperty(value = "订单二级类型:0-普通订单，1-积分订单，2-虚拟订单，4-视频号订单，5-云盘订单，6-卡密订单,7-预约订单,8-次卡订单")
    ...
    private BigDecimal merchantMemberDiscountPrice;
    ...
    @ApiModelProperty(value = "订单流转记录列表")
    private List<OrderFlowRecordVo> flowRecordList;

    @ApiModelProperty(value = "订单核销记录列表")
    private List<VerificationRecordResponse> verificationRecordList;
}
