...
public class SysConfigConstants {
    ...
    /** 分销提现方式：bankCard-银行卡，wechat-微信，alipay-支付宝，balance-余额 */
    public static final String RETAIL_STORE_EXTRACT_METHOD = "retail_store_extract_method";
    /** 分销提现-微信到账方式：0-线下转账，1-商家转账到零钱 */
    public static final String RETAIL_STORE_EXTRACT_WECHAT_METHOD = "retail_store_extract_wechat_method";
    /** 分销提现-微信转账场景ID */
    public static final String RETAIL_STORE_EXTRACT_WECHAT_SCENE_ID = "retail_store_extract_wechat_scene_id";
    ...
    /** 华为云上传URL */
    public static final String CONFIG_HW_OBS_UPLOAD_URL = "hwObsUploadUrl";
    /** 华为云Access Key */
    public static final String CONFIG_HW_OBS_ACCESS_KEY = "hwObsAccessKey";
    /** 华为云Secret Key */
    public static final String CONFIG_HW_OBS_SECRET_KEY = "hwObsSecretKey";
    /** 华为云存储桶名称 */
    public static final String CONFIG_HW_OBS_BUCKET_NAME = "hwObsBucketName";
    /** 华为云存储终端节点 */
    public static final String CONFIG_HW_OBS_ENDPOINT = "hwObsEndpoint";
    ...
    /** 店铺会员注册与授权协议 */
    public static final String SHOP_MEMBER_CARD_REGISTRATION_AUTHORIZATION_AGREEMENT = "shopMemberCardRegistrationAuthorizationAgreement";
    /** 商户会员开卡协议 */
    public static final String MERCHANT_MEMBER_CARD_OPEN_AGREEMENT = "merchantMemberCardOpenAgreement";
    /** 消费者权益保障说明 */
    public static final String CONSUMER_RIGHTS_PROTECTION_AGREEMENT = "consumerRightsProtectionAgreement";
