...
public class GroupConfig implements Serializable {
    ...
    @ApiModelProperty(value = "标签:1-首页banner,2-首页推荐，3-经营理念，4-友情链接, 5-快捷入口，6-商户PC店铺Banner，7-商户PC店铺商品推荐，8-首页底部二维码，9-首页广告,10-首页导航,11-付费会员权益,12-积分区间,13-开屏广告,14-底部导航")
    private Integer tag;
