...
public class ProductAddRequest implements Serializable {
    ...
    @ApiModelProperty(value = "基础类型：0=普通商品,1-积分商品,2-虚拟商品,4=视频号,5-云盘商品,6-卡密商品,7-预约商品", required = true)
...
//    private Boolean isPaidMember;
    ...
    @ApiModelProperty(value = "配送方式：1-商家配送,2-到店核销,3-到店服务,4-上门服务，逗号拼接")
    ...
    @Valid
    @ApiModelProperty(value = "预约商品补充信息")
    private ProductSupplementReservationRequest supplementReservation;

    @Valid
    @ApiModelProperty(value = "时段信息列表")
    private List<TimeSlot> timeSlotList;

    @ApiModelProperty(value = "核销次数")
    private Integer verifyQuantity;

    @ApiModelProperty(value = "核销期限类型：1-无期限，2-几天后，3-日期范围")
    private Integer verifyTimeLimitType;

    @ApiModelProperty(value = "核销期限天数")
    private Integer verifyTimeLimitDay;

    @ApiModelProperty(value = "核销期限日期范围-开始日期")
    private String verifyTimeLimitStartDate;

    @ApiModelProperty(value = "核销期限日期范围-结束日期")
    private String verifyTimeLimitEndDate;
