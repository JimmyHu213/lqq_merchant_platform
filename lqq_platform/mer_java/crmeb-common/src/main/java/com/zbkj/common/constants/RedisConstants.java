...
public class RedisConstants {
    ...
    public static final String REDIS_TOKEN_SERVICE_STAFF_KEY = "TOKEN:USER:SERVICE:STAFF:";
    /** 用户登token WEB存储前缀 */
    ...
    public static final String WEB_TOKEN_SERVICE_STAFF_KEY = "user:servicestaff:";
    ...
    public static final String FRONT_SERVICE_STAFF_TOKEN_SET_KEY = "FRONT:SERVICE:STAFF:TOKEN:{}";
    ...
    /** 圈层系统菜单缓存Key */
    public static final String CIRCLE_MENU_CACHE_LIST_KEY = "circleMenuList";
    ...
    /** 圈层后台账号登录错误数量keu **/
    public static final String CIRCLE_ACCOUNT_LOGIN_ERROR_NUM_KEY = "circle:account:login:error:{}";
