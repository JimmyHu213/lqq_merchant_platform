...
public class OrderConstants {
    ...
    /** 订单号前缀-工单 */
    public static final String ORDER_PREFIX_GD = "GD";
    /** 订单号前缀-购物金退款 */
    public static final String ORDER_PREFIX_SHOPPING_CREDITS_REFUND = "SCRE";
    /** 充值订单号前缀 */
    ...
    public static final String ADMIN_ORDER_UID = "147700";
    /** 购物金订单号前缀 */
    public static final String SHOPPING_CREDITS_ORDER_PREFIX = "GW";
...
//    public static final Integer ORDER_TYPE_CDKEY = 6;
    ...
    /** 订单二级类型-预约订单 */
    public static final Integer ORDER_SECOND_TYPE_RESERVATION = 7;
    /** 订单二级类型-次卡订单 */
    public static final Integer ORDER_SECOND_TYPE_CARDTIMES = 8;
    ...
    /** 订单配送方式-到店服务 */
    public static final Integer ORDER_SHIPPING_TYPE_TO_STORE = 4;
    /** 订单配送方式-上门服务 */
    public static final Integer ORDER_SHIPPING_TYPE_HOME_SERVICE = 5;
