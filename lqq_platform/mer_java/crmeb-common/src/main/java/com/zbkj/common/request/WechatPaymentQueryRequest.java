...
public class WechatPaymentQueryRequest implements Serializable {
    ...
    @ApiModelProperty(value = "订单类型:order-商品订单,recharge-充值订单,svip-付费会员订单,shoppingCredits-购物金订单")
    @NotBlank(message = "订单类型不能为空")
    @StringContains(limitValues = {"order", "recharge", "svip", "shoppingCredits"}, message = "未知的订单类型")
