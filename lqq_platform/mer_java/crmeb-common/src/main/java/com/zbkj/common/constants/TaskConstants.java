...
public class TaskConstants {
    ...
    /** 次卡订单有效期校验 key **/
    public static final String CARD_TIMES_ORDER_VALIDITY = "cardTimesOrderValidity";
    /** 次卡商品有效期校验 key **/
    public static final String CARD_TIMES_PRODUCT_VALIDITY = "cardTimesProductValidity";
