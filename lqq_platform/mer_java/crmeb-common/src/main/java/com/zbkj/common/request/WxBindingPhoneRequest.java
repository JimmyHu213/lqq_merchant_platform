...
public class WxBindingPhoneRequest implements Serializable {
    ...
    @ApiModelProperty(value = "类型:wechat-公众号，routine-小程序,iosWx-苹果微信，androidWx-安卓微信，pcWx-PC微信网页应用")
    @NotBlank(message = "类型不能为空")
    @StringContains(limitValues = {"wechat","routine","iosWx","androidWx","pcWx"}, message = "未知的类型")
    private String type;
