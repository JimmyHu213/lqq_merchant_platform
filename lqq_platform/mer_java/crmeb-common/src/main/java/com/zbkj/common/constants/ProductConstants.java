...
public class ProductConstants {
    ...
    /** 商品类型——积分商品 */
    public static final Integer PRODUCT_TYPE_INTEGRAL = 1;
    /** 商品类型——虚拟商品 */
    public static final Integer PRODUCT_TYPE_VIRTUALLY = 2;
    /** 商品类型——组件商品/视频号 */
    ...
    /** 商品类型——预约商品 */
    public static final Integer PRODUCT_TYPE_RESERVATION = 7;
    /** 商品类型——次卡商品 */
    public static final Integer PRODUCT_TYPE_CARDTIMES = 8;

    /** 商品营销类型——基础 */
    public static final Integer PRODUCT_MARKETING_TYPE_BASE = 0;
    /** 商品营销类型——秒杀 */
    public static final Integer PRODUCT_MARKETING_TYPE_SECKILL = 1;
    /** 商品营销类型——基础 */
    public static final Integer PRODUCT_MARKETING_TYPE_PINGTUAN = 2;
    ...
    /** 次卡商品核销期限类型-无期限 */
    public static final Integer CARD_TIMES_VALIDITY_LIMIT_NO= 1;
    /** 次卡商品核销期限类型-几天后 */
    public static final Integer CARD_TIMES_VALIDITY_LIMIT_DAY = 2;
    /** 次卡商品核销期限类型-固定日期 */
    public static final Integer CARD_TIMES_VALIDITY_LIMIT_DATE = 3;
