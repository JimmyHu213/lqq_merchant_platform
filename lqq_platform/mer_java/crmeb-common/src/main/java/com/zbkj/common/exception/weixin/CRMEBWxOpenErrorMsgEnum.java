...
@Getter
public enum CRMEBWxOpenErrorMsgEnum {
  /**
...
//    CODE_85015(85015, "版本输入错误"),
  ...
  CODE_300037(300037, "购物直播频道封面图不合规"),

  CODE_300039(300039, "主播副号微信号不合法"),

  CODE_300040(300040, "名称含有非限定字符（含有特殊字符）"),

  CODE_300041(300041, "创建者微信号不合法"),

  CODE_300044(300044, "商品没有讲解视频"),

  CODE_300045(300045, "讲解视频未生成"),

  CODE_300047(300047, "已有商品正在推送，请稍后再试"),

  CODE_300048(300048, "拉取商品列表失败"),

  CODE_300049(300049, "商品推送过程中不允许上下架"),
  ...
  CRMEBWxOpenErrorMsgEnum(int code, String msg) {
    this.code = code;
    this.msg = msg;
  }
  ...
  static {
    for (CRMEBWxOpenErrorMsgEnum value : CRMEBWxOpenErrorMsgEnum.values()) {
