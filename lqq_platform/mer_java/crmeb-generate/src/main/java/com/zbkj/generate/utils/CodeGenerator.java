...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/crmeb-generate/src/main/java");
        gc.setAuthor("dazongzi");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/java_mer_dev?characterEncoding=utf-8&useSSL=false&serverTimeZone=GMT+8");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("java_mer_dev");
        ...
        pc.setParent("com.zbkj.generate.code");//controller entity  service  service.impl
