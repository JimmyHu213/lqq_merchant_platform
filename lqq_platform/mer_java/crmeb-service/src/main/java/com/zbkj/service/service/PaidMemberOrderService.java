...
public interface PaidMemberOrderService extends IService<PaidMemberOrder> {
     ...
     */
    Integer getPaidMemberNum(DateRequest dateRequest);
     ...
     * @param date 日期
     */
    Integer getPaidMemberNumByDate(String date, DateRequest dateRequest);
     ...
     * @param uid
     */
    Boolean userIsFirstCharge(Integer uid);
}