...
public class MerchantOrderServiceImpl extends ServiceImpl<MerchantOrderDao, MerchantOrder> implements MerchantOrderService {
     ...
     */
    @Override
    public List<MerchantOrder> statistics(Integer merId) {
        return dao.selectMerchantOrderStatistics(merId);
    }
     ...
     * @return Integer
     */
    public Integer getOrderProductNumByDateAndMerId(String date, Integer merId) {
        return dao.getOrderProductNumByDateAndMerId(date, merId);
    }
}
