...
public interface OrderService extends IService<Order> {
    ...
    Boolean verificationOrder(OrderVerificationRequest request, SystemAdmin systemAdmin, String merchant);
     ...
     * @return Integer
     */
    Integer getPayOrderNumByDate(Integer merId, String date);
     ...
     * @param merIds 商户id集合
     */
    Integer getOrderNumByMerIds(List<Integer> merIds);
     ...
     * @param merIds 商户id集合
     */
    BigDecimal getPayOrderAmountByMerIds(List<Integer> merIds);
     ...
     * @param merIds 商户id集合
     */
    BigDecimal getPayOrderAmountByMerIdsAnDate(List<Integer> merIds, String date);
     ...
     * @param date 日期，yyyy-MM-dd格式
     */
    Integer getOrderNumByMerIdsAndDate(List<Integer> merIds, String date);
     ...
     * @return 待发货订单量
     */
    Integer getNotShippingNumByMerIds(List<Integer> merIds);
     ...
     * @return 待核销订单量
     */
    Integer getAwaitVerificationNumByMerIds(List<Integer> merIds);
     ...
     * @return PageInfo
     */
    PageInfo<PlatformOrderPageResponse> getCircleOrderPage(List<Integer> merIdList, OrderSearchRequest request);

    /**
     * 获取圈层端订单各状态数量
     */
    OrderCountItemResponse getCircleOrderStatusNum(List<Integer> merIdList, OrderTabsHeaderRequest request);
     ...
     * @return
     */
    List<Order> statistics(Integer merId);
     ...
     * @return BigDecimal
     */
    BigDecimal getCouponOrderAmountByDate(Integer merId, String date);
     ...
     * @return Integer
     */
    Integer getOrderUserNum(DateRequest dateRequest);

    /**
     * 获取下单用户数
     * @param date 日期
     */
    Map<String, Integer> getOrderUserNum(String date, DateRequest dateRequest);

    /**
     * 获取消费单数
     */
    Integer getConsumeOrderNumByMerAndUid(Integer merId, Integer userId);
     ...
     * @param merId 商户id
     */
    Integer getOrderNumByMerIdAndDateRequest(DateRequest dateRequest, Integer merId);
     ...
     * @param dateRequest 日期请求对象
     */
    List<Integer> getOrderUidList(Integer merId, String date, DateRequest dateRequest);
     ...
     */
    BigDecimal getConsumeAmountByMerIdAndDate(Integer merId, String startDateTime, String endDateTime);
     ...
     * @param endDateTime   结束时间
     */
    Integer getConsumeOrderNumByMerIdAndDate(Integer merId, String startDateTime, String endDateTime);
     ...
     * @param endDateTime   结束时间
     */
    Integer getConsumeMemberNumByMerIdAndDate(Integer merId, String startDateTime, String endDateTime);
