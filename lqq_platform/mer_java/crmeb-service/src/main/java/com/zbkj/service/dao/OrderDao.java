...
public interface OrderDao extends BaseMapper<Order> {
    ...
    List<PlatformOrderPageResponse> getCircleOrderPage(Map<String, Object> map);

    Integer getCircleOrderPageCount(Map<String, Object> map);

    Integer selectMerchantOrderCount(@Param("merId") Integer merId,
                                     @Param("startTime")  String startTime,
                                     @Param("endTime") String endTime);

    BigDecimal getConsumeAmountByMerIdAndDate(@Param("merId") Integer merId,
                                              @Param("startDateTime")  String startDateTime,
                                              @Param("endDateTime") String endDateTime);

    Integer getConsumeOrderNumByMerIdAndDate(@Param("merId") Integer merId,
                                             @Param("startDateTime")  String startDateTime,
                                             @Param("endDateTime") String endDateTime);

    Integer getConsumeMemberNumByMerIdAndDate(@Param("merId") Integer merId,
                                              @Param("startDateTime")  String startDateTime,
                                              @Param("endDateTime") String endDateTime);
}
