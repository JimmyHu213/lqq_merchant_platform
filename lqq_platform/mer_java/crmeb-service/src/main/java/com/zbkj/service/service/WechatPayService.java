...
//    WxPayRefundNotifyResult parseRefundNotifyResult(String xmlData, String appid);
     ...
     * @return
     */
    MyRecord transferToSmallChange(String openId, String outBillNo, BigDecimal transferAmount);

    /**
     * 查询微信商家转账结果
     */
    TransferBillsGetResult queryWechatTransferResult(String orderNo);
}
