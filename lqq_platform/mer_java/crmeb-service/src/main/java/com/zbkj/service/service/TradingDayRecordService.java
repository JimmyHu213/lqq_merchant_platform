...
public interface TradingDayRecordService extends IService<TradingDayRecord> {
    ...
    TradingDayRecord getStatisticsByDateRequest(DateRequest dateRequest);

    OrderStatisticsChartResponse getStatisticsByDate(String date, DateRequest dateRequest);
}