...
public class PaidMemberOrderServiceImpl extends ServiceImpl<PaidMemberOrderDao, PaidMemberOrder> implements PaidMemberOrderService {
     ...
     */
    @Override
    public Integer getPaidMemberNum(DateRequest dateRequest) {
        QueryWrapper<PaidMemberOrder> wrapper = new QueryWrapper<>();
     ...
     * @param date 日期
     */
    public Integer getPaidMemberNumByDate(String date, DateRequest dateRequest) {
        QueryWrapper<PaidMemberOrder> wrapper = new QueryWrapper<>();
        wrapper.select("COUNT(DISTINCT uid) as userCount");
        wrapper.eq("paid", Boolean.TRUE);
    ...
    @Override
    public Boolean userIsFirstCharge(Integer uid) {
        LambdaQueryWrapper<PaidMemberOrder> lqw = Wrappers.lambdaQuery();
