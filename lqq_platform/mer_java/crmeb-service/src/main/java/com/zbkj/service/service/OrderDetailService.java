...
public interface OrderDetailService extends IService<OrderDetail> {
     ...
     * @param timeSlot 时间段
     */
    Integer getSalesNumCountByReservationIngo(Integer attrValueId, String reservationDate, String timeSlot);
     ...
     * @param userId 用户ID
     */
    BigDecimal getConsumptionAmountByMerAndUid(Integer merId, Integer userId);
     ...
     * @return Integer
     */
    Integer getOrderProductNum(String date, Integer productId);
     ...
     * @return Integer
     */
    Integer getSalesNumByDateAndMerId(String date, Integer merId);
