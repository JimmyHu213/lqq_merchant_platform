...
public interface ShoppingProductDayRecordService extends IService<ShoppingProductDayRecord> {
    ...
    ShoppingProductDayRecord getStatisticsByDateRequest(DateRequest dateRequest);

    ProductStatisticsChartResponse getStatisticsByDate(String date, DateRequest dateRequest);
}