...
public interface ProductDao extends BaseMapper<Product> {
     ...
     * @param map 查询参数
     */
    List<PlatformProductListResponse> getCircleProductPageList(Map<String, Object> map);

    /**
     * 圈层端商品分页列表数量
     */
    Integer getCircleProductPageCount(Map<String, Object> map);

    List<Product> findIndexProductListComponent(Map<String, Object> map);
}
