...
public interface RetailStoreService {
     ...
     * 分销基础配置信息获取
     */
    RetailStoreBaseConfigVo getRetailStoreBaseConfig();

    /**
     * 分销基础配置信息保存
     */
    Boolean saveRetailStoreBaseConfig(RetailStoreBaseConfigVo retailShopRequest);

    /**
     * 分销提现配置信息获取
     */
    RetailStoreExtractConfigVo getRetailStoreExtractConfig();

    /**
     * 分销提现配置信息保存
     */
    Boolean saveRetailStoreExtractConfig(RetailStoreExtractConfigVo retailShopRequest);
     ...
     * @return Boolean
     */
    UserClosingApplyResponse userClosingApply(UserClosingApplyRequest request);
