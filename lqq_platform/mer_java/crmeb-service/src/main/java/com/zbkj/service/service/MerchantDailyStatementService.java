...
public interface MerchantDailyStatementService extends IService<MerchantDailyStatement> {
    ...
    MerchantDailyStatement getStatisticsByDateRequest(DateRequest dateRequest, Integer merId);
    OrderStatisticsChartResponse getStatisticsByDate(String date, DateRequest dateRequest, Integer merId);
}
