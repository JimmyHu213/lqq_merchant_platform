...
public interface ProductDayRecordService extends IService<ProductDayRecord> {
    ...
    ProductDayRecord getStatisticsByDateRequest(DateRequest dateRequest, Integer merId);

    ProductStatisticsChartResponse getStatisticsByDate(String date, DateRequest dateRequest, Integer merId);
}