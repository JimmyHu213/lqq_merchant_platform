...
public interface UserService extends IService<User> {
     ...
     * @return PageInfo
     */
    PageInfo<UserResponse> getMerchantPage(MerchantUserSearchRequest request);
     ...
     * @return 用户列表
     */
    List<User> findExportList(UserSearchRequest request);
     ...
     * @return 分销员列表
     */
    List<User> findRetailStorePeopleList(RetailStorePeopleSearchRequest request);

    /**
     * 根据用户id集合获取渠道数据
     */
    List<User> getChannelDataByIds(List<Integer> userIds);

    /**
     * 获取用户固定数据
     * @return 用户数量 付费会员数量
     */
    Map<String, Integer> getFixedUserData();

    /**
     * 获取新增用户数量
     * @param dateRequest 日期
     */
    Integer getAddUserNum(DateRequest dateRequest);

    /**
     * 获取新增用户数量
     * @param date 日期
     */
    Integer getUserAddNum(String date, DateRequest dateRequest);
     ...
     */
    Integer getUserAddNumByUidList(String date, List<Integer> uidList);
}
