...
public interface MerchantService extends IService<Merchant> {
     ...
     * @return List
     */
    PageInfo<MerchantSearchResponse> getStreet(MerchantStreetRequest request);
     ...
     * @return 商户定位信息
     */
    Merchant getLocationInfo(Integer merId);
     ...
     * @return 分页数据
     */
    PageInfo<MerchantPageResponse> getCircleMerchantPage(List<Integer> merIdList, MerchantSearchRequest searchRequest, PageParamRequest pageParamRequest);
     ...
     * @return 商户数量统计数据
     */
    MerchantHeaderNumResponse getCircleMerchantNum(List<Integer> merIdList, MerchantSearchRequest searchRequest);

    /**
     * 获取圈层店铺街
     */
    List<Merchant> getRegionStreet(List<Integer> merIdList);

    /**
     * 获取圈层首页商户列表
     */
    List<Merchant> findRegionHomeMerchantList(List<Integer> merIdList, Integer num);
     ...
     * @return 未绑定圈层的商户列表
     */
    List<CircleMerchantResponse> getCircleMerchantsUnBind(Integer circleId);

    /**
     * 获取首页商户列表
     */
    List<Merchant> findIndexMerchantList(List<Integer> merIdList, Integer num);
}
