...
public interface HomeService {
     ...
     * 圈层端 首页数据
     */
    PlatformHomeRateResponse indexCircleData(List<Integer> merIds);

    /**
     * 圈层端 经营数据
     */
    HomeOperatingDataResponse operatingCircleData(List<Integer> merIds);

    /**
     * 圈层端 用户渠道比例
     */
    List<UserChannelDataResponse> getCircleUserChannelData(List<Integer> merIds);
}
