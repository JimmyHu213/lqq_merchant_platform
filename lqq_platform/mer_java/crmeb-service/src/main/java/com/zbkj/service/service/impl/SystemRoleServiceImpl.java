...
public class SystemRoleServiceImpl extends ServiceImpl<SystemRoleDao, SystemRole> implements SystemRoleService {
    ...
    public Integer getRoleTypeByCurrentAdmin() {
        ...
        if (currentAdmin.getType().equals(RoleEnum.CIRCLE_SUPER.getValue()) ||
                currentAdmin.getType().equals(RoleEnum.CIRCLE_ADMIN.getValue())) {
            return RoleEnum.CIRCLE_ADMIN.getValue();
        }
        if (currentAdmin.getType().equals(RoleEnum.CIRCLE_SUPER.getValue()) ||
                currentAdmin.getType().equals(RoleEnum.CIRCLE_ADMIN.getValue())) {
            return RoleEnum.CIRCLE_ADMIN.getValue();
    ...
    private Integer getRoleTypeByCurrentAdmin(Integer type) {
        ...
        if (type.equals(RoleEnum.CIRCLE_SUPER.getValue()) || type.equals(RoleEnum.CIRCLE_ADMIN.getValue())) {
            return RoleEnum.CIRCLE_ADMIN.getValue();
        }
        if (type.equals(RoleEnum.CIRCLE_SUPER.getValue()) || type.equals(RoleEnum.CIRCLE_ADMIN.getValue())) {
            return RoleEnum.CIRCLE_ADMIN.getValue();
