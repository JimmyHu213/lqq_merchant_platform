...
public interface OrderDetailDao extends BaseMapper<OrderDetail> {
     ...
     * @param timeSlot 时间段
     */
    Integer getSalesNumCountByReservationIngo(@Param("attrValueId") Integer attrValueId, @Param("reservationDate") String reservationDate, @Param("timeSlot") String timeSlot);

    /**
     * 获取累计消费金额
     */
    BigDecimal getConsumptionAmountByMerAndUid(@Param("merId") Integer merId, @Param("userId") Integer userId);
     ...
     * @param proId 商品id
     */
    Integer getOrderProductNum(@Param("date") String date, @Param("proId")  Integer proId);

    Integer getSalesNumByDateAndMerId(@Param("date") String date, @Param("merId")  Integer merId);
