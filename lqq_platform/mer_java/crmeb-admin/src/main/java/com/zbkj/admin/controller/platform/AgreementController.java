...
public class AgreementController {
    ...
    @PreAuthorize("hasAuthority('platform:system:agreement:shop:member:card:registration:authorization:save')")
    @ApiOperation(value = "店铺会员注册与授权协议 保存")
    @RequestMapping(value = "/shop/member/card/registration/authorization/save", method = RequestMethod.POST)
    public CommonResult<Boolean> shopMemberCardRegistrationAuthorizationSave(@RequestBody @NotEmpty String agreement) {
        return CommonResult.success(systemConfigService.updateOrSaveValueByName(SysConfigConstants.SHOP_MEMBER_CARD_REGISTRATION_AUTHORIZATION_AGREEMENT, agreement));
    }

    @PreAuthorize("hasAuthority('platform:system:agreement:shop:member:card:registration:authorization:info')")
    @ApiOperation(value = "店铺会员注册与授权协议 详情")
    @RequestMapping(value = "/shop/member/card/registration/authorization/info", method = RequestMethod.GET)
    public CommonResult<String> shopMemberCardRegistrationAuthorizationInfo() {
        return CommonResult.success(systemConfigService.getAgreementByKey(SysConfigConstants.SHOP_MEMBER_CARD_REGISTRATION_AUTHORIZATION_AGREEMENT));
    }

    @PreAuthorize("hasAuthority('platform:system:agreement:consumer:rights:protection:save')")
    @ApiOperation(value = "消费者权益保障说明 保存")
    @RequestMapping(value = "/consumer/rights/protection/save", method = RequestMethod.POST)
    public CommonResult<Boolean> consumerRightsProtectionSave(@RequestBody @NotEmpty String agreement) {
        return CommonResult.success(systemConfigService.updateOrSaveValueByName(SysConfigConstants.CONSUMER_RIGHTS_PROTECTION_AGREEMENT, agreement));
    }

    @PreAuthorize("hasAuthority('platform:system:agreement:consumer:rights:protection:info')")
    @ApiOperation(value = "消费者权益保障说明 详情")
    @RequestMapping(value = "/consumer/rights/protection/info", method = RequestMethod.GET)
    public CommonResult<String> consumerRightsProtectionInfo() {
        return CommonResult.success(systemConfigService.getAgreementByKey(SysConfigConstants.CONSUMER_RIGHTS_PROTECTION_AGREEMENT));
    }
}
