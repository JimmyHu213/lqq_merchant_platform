...
//            .antMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                ...
                .antMatchers("/api/admin/circle/login").permitAll()
                .antMatchers("/api/admin/circle/login/account/detection").permitAll()
                .antMatchers("/api/admin/circle/getLoginPic").permitAll()
                // 放行资源路径
