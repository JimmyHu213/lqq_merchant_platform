...
@Slf4j
@RestController
@RequestMapping("api/admin/platform/system/group/data")
@Api(tags = "设置 -- 组合数据 -- 详情")
public class SystemGroupDataController {
     ...
     */
    @PreAuthorize("hasAuthority('platform:system:group:data:list')")
     ...
     */
    @PreAuthorize("hasAuthority('platform:system:group:data:save')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:system:group:data:delete')")
     ...
     * @param request 修改参数
     */
    @PreAuthorize("hasAuthority('platform:system:group:data:update')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:system:group:data:info')")
