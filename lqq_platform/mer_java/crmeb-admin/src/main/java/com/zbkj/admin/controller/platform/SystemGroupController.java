...
@Slf4j
@RestController
@RequestMapping("api/admin/platform/system/group")
@Api(tags = "设置 -- 组合数据")
public class SystemGroupController {
     ...
     */
    @PreAuthorize("hasAuthority('platform:system:group:list')")
     ...
     */
    @PreAuthorize("hasAuthority('platform:system:group:save')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:system:group:delete')")
     ...
     */
    @PreAuthorize("hasAuthority('platform:system:group:update')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:system:group:info')")
