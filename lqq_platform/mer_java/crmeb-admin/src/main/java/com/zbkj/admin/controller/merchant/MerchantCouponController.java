...
public class MerchantCouponController {
    ...
    @PreAuthorize("hasAuthority('merchant:coupon:member:usable:list')")
    @ApiOperation(value = "商户会员可用优惠券列表")
    @RequestMapping(value = "/member/usable/list", method = RequestMethod.GET)
    public CommonResult<List<ProductCouponUseResponse>> findMemberUsableList() {
        return CommonResult.success(couponService.findMemberUsableList());
    }
}
