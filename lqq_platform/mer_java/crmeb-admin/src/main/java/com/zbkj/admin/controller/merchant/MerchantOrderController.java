...
public class MerchantOrderController {
    ...
    public CommonResult<CommonPage<MerchantOrderPageResponse>> getList(@Validated OrderSearchRequest request) {
        return CommonResult.success(CommonPage.restPage(manageOrderService.getMerchantAdminPage(request)));
    }
    ...
    public CommonResult<OrderCountItemResponse> getOrderStatusNum(@Validated OrderTabsHeaderRequest request) {
        return CommonResult.success(manageOrderService.getMerchantOrderStatusNum(request));
    }
    ...
    public CommonResult<String> delete(@PathVariable(name = "orderNo") String orderNo) {
        if (manageOrderService.merchantDeleteByOrderNo(orderNo)) {
    ...
    public CommonResult<String> mark(@RequestBody @Validated OrderRemarkRequest request) {
        if (manageOrderService.merchantMark(request)) {
            return CommonResult.success();
        }
        return CommonResult.failed();
    }
    ...
    public CommonResult<OrderAdminDetailResponse> info(@PathVariable(value = "orderNo") String orderNo) {
        return CommonResult.success(manageOrderService.adminDetail(orderNo));
    }
    ...
    public CommonResult<List<OrderDetailInfoResponse>> getDetailList(@PathVariable(value = "orderNo") String orderNo) {
        return CommonResult.success(manageOrderService.getDetailList(orderNo));
    }
    ...
    public CommonResult<Boolean> send(@RequestBody @Validated OrderSendRequest request) {
        if (manageOrderService.send(request)) {
            return CommonResult.success();
        }
        return CommonResult.failed();
    }
    ...
    public CommonResult<Boolean> printReceipt(@PathVariable(value = "orderno") String orderno) {
        manageOrderService.printReceipt(orderno);
        return CommonResult.success();
    ...
    public CommonResult<List<OrderInvoiceResponse>> getInvoiceList(@PathVariable(value = "orderNo") String orderNo) {
        return CommonResult.success(manageOrderService.getInvoiceListByMerchant(orderNo));
    }
    ...
    public CommonResult<LogisticsResultVo> getLogisticsInfo(@PathVariable(value = "invoiceId") Integer invoiceId) {
        return CommonResult.success(manageOrderService.getLogisticsInfoByMerchant(invoiceId));
    }
    ...
    //    return CommonResult.success(manageOrderService.verificationOrderByCode(request.getVerifyCode()));
    //}
    ...
    @ApiOperation(value = "核销码核销订单")
    @RequestMapping(value = "/verification", method = RequestMethod.POST)
    public CommonResult<Object> verificationOrderCard(@RequestBody OrderVerificationRequest request) {
        return CommonResult.success(manageOrderService.verificationOrder(request));
    }
    ...
    public CommonResult<Object> directRefund(@RequestBody @Validated MerchantOrderDirectRefundRequest request) {
        if (manageOrderService.directRefund(request)) {
    ...
    public CommonResult<Object> updateInvoice(@RequestBody @Validated OrderInvoiceUpdateRequest request) {
        if (manageOrderService.updateInvoice(request)) {
