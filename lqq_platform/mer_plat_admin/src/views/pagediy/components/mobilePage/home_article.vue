<template>
  <div v-if="configObj">
    <div class="mobile-page" :style="boxStyle">
      <div class="list">
        <div v-if="articleList.length === 0" class="item acea-row" :style="layoutConfig">
          ...
          <div class="text" :class="configObj.layoutConfig.tabVal === 0 ? 'ml10' :'mr-20'">
        ...
        <template v-if="articleList.length > 0">
          ...
          >
            ...
            <div class="text" :class="configObj.layoutConfig.tabVal === 0 ? 'ml10' :'mr10'">
              <div class="name line2 tui-skeleton-rect" :style="titleColor">{{ item.title }}</div>
              <div class="tui-skeleton-rect" :style="timeColor">{{ item.createTime }}</div>
            </div>
          </div>
        </template>
      </div>
