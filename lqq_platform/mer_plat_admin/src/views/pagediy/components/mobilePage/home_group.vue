...
export default {
  ...
  computed: {
    ...
    groupTitleColor() {
      return {
        backgroundColor: this.themeStyle ? this.configObj.groupTitleColor.color[0].item : this.themeColor,
      };
    },
    //已拼颜色
    groupTitleFontColor() {
      return [
        {
          color: this.themeStyle ? this.configObj.groupTitleColor.color[0].item : this.themeColor,
        },
      ];
    },
    //按钮颜色
