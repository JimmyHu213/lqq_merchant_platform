    ...
    <el-card class="box-card mt14" :body-style="{ padding: '20px' }" shadow="never" :bordered="false">
      ...
      >
        ...
        <el-table-column label="操作" width="130">
          <template slot-scope="scope">
            <template
                v-if="checkPermi(['platform:wechat:public:keywords:reply:info'])
              "
            >
              <router-link :to="{ path: `/operation/application/publicAccount/wxReply/keyword/save/${scope.row.id}/info`}">
                <a>详情</a>
              </router-link>
