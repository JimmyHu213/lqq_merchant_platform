<template>
  <div class="divBox">
    <pages-header
      ...
      ref="pageHeader"
      :title="this.$route.params.id ? (isDisabled ? '关键字详情' : '关键字编辑') : '关键字添加'"
    ...
    <el-card class="box-card mt14" :bordered="false" shadow="never" :body-style="{ padding: '40px 50px' }">
      <el-row :gutter="30" v-loading="loading">
                ...
                <div class="newsBox">
                  <div
                    ...
                    :style="{
                      backgroundImage:
                        'url(' +
                        (formValidate.contents.articleData.cover ? formValidate.contents.articleData.cover : '') +
                        ')',
        ...
        <el-col :xl="11" :lg="12" :md="14" :sm="22" :xs="22">
              ...
              >
                <div class="acea-row row-middle">
                  ...
                  <el-upload
                    ...
                    multiple
                  >
                    <el-button v-show="!isDisabled" size="mini" type="primary">点击上传</el-button>
                  </el-upload>
                </div>
          ...
          <el-col v-show="!isDisabled" :span="24">
...
export default {
  ...
  data() {
    ...
    return {
      isDisabled: this.$route.params.isDisabled === 'info' ? true : false,
      loading: false,
      visible: false,
      grid: {
        xl: 7,
