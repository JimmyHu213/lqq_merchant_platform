                  ...
                  <div class="tianjia">
                    ...
                    >
                      <el-tooltip class="item" effect="dark" :content="j.name" placement="top-start">
                        <div class="line1" style="width: 93px">{{ j.name || '二级菜单' }}</div>
                      </el-tooltip>
                    </div>
                  </div>
                </div>
                ...
                <el-form ref="formValidate" :model="formValidate" :rules="ruleValidate" label-width="80px" class="mt20">
                  <el-form-item label="菜单名称" prop="name"
                    ...
                    <el-input
                      ...
                      :maxlength="parentMenuId || parentMenuId === 0 ? 8 : 4"
                      placeholder="请填写菜单名称"
...
export default {
  ...
  mounted() {
    if (checkPermi(['platform:wechat:public:customize:menu:get'])) this.getMenus();
    if (this.list.length) {
