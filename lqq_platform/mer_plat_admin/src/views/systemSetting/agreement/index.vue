      ...
      <div v-loading="loading">
        <el-tabs
          ...
          v-hasPermi="[
            ...
            'platform:system:agreement:consumer:rights:protection:info'
          ]"
        >
          <el-tab-pane v-for="(item, index) in tabList" :key="index" :name="item.info">
            <div
              slot="label"
              class="wrap-text"
              :class="{ 'line-height-normal': item.title == '店铺会员卡注册及授权协议' }"
            >
              {{ item.title }}
            </div>
            <div class="content">
        ...
        <div class="btn">
          <el-button
            ...
            v-hasPermi="[
              ...
              'platform:system:agreement:consumer:rights:protection:save'
            ]"
            >提交</el-button
          >
        </div>
  ...
  data() {
    return {
      ...
      tabList: [
        ...
        { title: '优惠券协议', id: 9, info: 'coupon/agreement/info', save: 'coupon/agreement/save' },
        { title: '付费会员协议', id: 10, info: 'paid/member/info', save: 'paid/member/save' },
        {
          title: '店铺会员卡注册及授权协议',
          id: 11,
          info: 'shop/member/card/registration/authorization/info',
          save: 'shop/member/card/registration/authorization/save',
        },
        {
          title: '消费者权益保障说明',
          id: 12,
          info: 'consumer/rights/protection/info',
          save: 'consumer/rights/protection/save',
        },
      ],
      formValidate: {
        agreement: '',
