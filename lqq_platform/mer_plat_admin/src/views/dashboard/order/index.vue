<template>
  <div>
    ...
    <!-- 统计数据 -->
    <div v-if="orderStatisticsData.length && checkPermi(['platform:order:statistics:top'])" class="mt14">
      <statistics-data-card-list :statisticsData="orderStatisticsData"></statistics-data-card-list>
    </div>
    <!-- 统计图像 -->
    <div class="statistic-image-box">
      <!-- 订单折线图 -->
      <el-row class="mt14" v-if="checkPermi(['platform:order:statistics:chart'])">
        <el-col :span="24">
      ...
      <el-row class="mt14" :gutter="14">
        <!-- 订单类型图 -->
        <el-col :span="12" v-if="checkPermi(['platform:order:statistics:type'])">
        ...
        <!-- 发货方式图 -->
        <el-col :span="12" v-if="checkPermi(['platform:order:statistics:shipping'])">
