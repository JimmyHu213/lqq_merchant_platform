        ...
        <el-card :bordered="false" dis-hover :padding="12" shadow="never">
          ...
          <div class="content" v-if="viewData">
            ...
            <div class="acea-row row-between-wrapper">
              ...
              <span class="content-time">{{ viewData.yesterdayNewMerchantNum || 0 }} </span>
            </div>
          </div>
        </el-card>
      </el-col>
      <el-col v-bind="grid" class="ivu-mb">
        <el-card :bordered="false" dis-hover :padding="12" shadow="never">
          ...
          <div class="content" v-if="viewData">
            ...
            <div class="acea-row row-between-wrapper">
              <span class="content-time">昨日数据</span>
              <span class="content-time">{{ viewData.yesterdayNewUserNum || 0 }} </span>
            </div>
          </div>
        </el-card>
      </el-col>
...
export default {
  data() {
    return {
      grid: { xl: 8, lg: 8, md: 12, sm: 12, xs: 24 },
      viewData: {},
    };
  },
  methods: {
    statisticsOrder() {
      if (isPlatform) {
        ...
        areaApi.areasNodeHomeIndexApi().then(async (res) => {
          this.viewData = res;
        }).catch(error => {
