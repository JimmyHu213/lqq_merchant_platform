<template>
  <div class="divBox">
    ...
    <el-card class="box-card mt14" :body-style="{ padding: '20px' }" shadow="never" :bordered="false">
      <el-button size="small" @click="handleExports" v-hasPermi="['platform:export:retail:store:people:excel']">导出</el-button>
      <el-table
    ...
    <el-dialog :title="titleName + '列表'" :visible.sync="dialogVisible" width="900px" :before-close="handleClose">
      <div class="container">
        <el-form size="small" inline @submit.native.prevent label-width="72px">
...
// +---------------------------------------------------------------------
import {promoterListApi, spreadListApi, spreadOrderListApi, spreadClearApi, peopleExcelApi} from '@/api/distribution';
...
export default {
  ...
  methods: {
    ...
    // 导出
    handleExports() {
      peopleExcelApi(this.tableFrom).then((res) => {
