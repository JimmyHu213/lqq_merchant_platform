      ...
      <div v-loading="loading">
        ...
        <el-tabs type="border-card" v-model="activeName">
          ...
          <el-tab-pane label="订单信息" name="detail" v-if="refundInfo.orderInfoVo">
            ...
            <div class="detailSection">
              ...
              <ul class="list">
                ...
                <li class="item">
                  ...
                  <div class="value">￥{{ refundInfo.orderInfoVo.merchantMemberDiscountPrice || 0 }}</div>
                </li>
                <li class="item">
            ...
            <div class="detailSection" v-if="refundInfo.orderInfoVo.secondType == OrderSecondTypeEnum.PunchCard">
              <div class="title">核销信息</div>
              <ul class="list">
                <li class="item">
                  <div class="lang">待核销次数：</div>
                  <div class="value">{{ refundInfo.verifyRemainingTimes }}</div>
                </li>
                <li class="item">
                  <div class="lang">总次数：</div>
                  <div class="value">{{ refundInfo.verifyTotalTimes }}</div>
                </li>
              </ul>
            </div>
            <div class="detailSection">
...
export default {
  ...
  methods: {
    ...
    getRefundOrderDetail(id) {
      this.loading = true;
      const api = isPlatform ? refundOrderDetailApi : areaApi.areasRefundOrderDetailApi;
      api(id)
        .then(async (res) => {
          this.refundInfo = res;
          this.loading = false;
