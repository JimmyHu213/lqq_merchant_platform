...
import { areasMerchantCategoryListApi, areasMerchantListApi, areasMerchantTypeListApi } from '@/api/area';
...
const actions = {
  ...
  getMerchantClassify({ commit }) {
    return new Promise((resolve, reject) => {
      const api = isPlatform ? merchant.merchantCategoryAllListApi : areasMerchantCategoryListApi;
      api()
        .then(async (res) => {
  ...
  getMerchantType({ commit }) {
    return new Promise((resolve, reject) => {
      const apiCall = isPlatform ? merchant.merchantTypeAllListApi() : areasMerchantTypeListApi();
      apiCall
        .then(async (res) => {
