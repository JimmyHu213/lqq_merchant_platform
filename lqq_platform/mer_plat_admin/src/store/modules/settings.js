...
const state = {
  ...
  tencentMapKey: localStorage.getItem('tencentMapKey') || '', //腾讯地图API Key
};
const mutations = {
  ...
  // 腾讯地图API Key
  SET_tencentMapKey(state, tencentMapKey) {
    state.tencentMapKey = tencentMapKey;
    localStorage.setItem('tencentMapKey', tencentMapKey);
    if (!tencentMapKey) localStorage.removeItem('tencentMapKey');
  },
};
