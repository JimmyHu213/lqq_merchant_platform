 ...
 * meta : {
 ...
 isAffix: true                  if set true, the tag will affix in the tags-view
...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        name: 'Dashboard',
        meta: { title: '首页', icon: 'dashboard', isAffix: true },
      },
      {
  ...
  },
  {
    ...
    component: () => import('@/views/maintain/systemForm/creatSystemFrom'),
    hidden: true,
  },
  {
