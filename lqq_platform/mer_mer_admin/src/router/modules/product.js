...
const productRouter = {
  ...
  children: [
    ...
    {
      //id:商品id，isDisabled：是否能编辑(1不能，2能)，isCopy：是否是采集商品(1是，2不是),productType:商品类型,isEdit:是编辑还是复制商品
      path: 'list/creatProduct/:id?/:isDisabled/:isCopy/:productType/:editOrCopy?',
    ...
    {
      path: 'reservation',
      component: () => import('@/views/product/reservation/index'),
      name: 'Reservation',
      meta: { title: '预约设置', icon: '' },
      children: [
        {
          path: 'toDoorService',
          component: () => import('@/views/product/reservation/ToDoorService/index'),
          name: 'ToDoorService1',
          meta: { title: '上门服务', icon: '' },
        },
        {
          path: 'inStoreService',
