...
// 页面底部导航
export function bottomNavigationGetApi() {
  return request({
    url: `/admin/merchant/page/layout/bottom/navigation/get`,
    method: 'get',
  });
}

// 底部导航保存
export function bottomNavigationSaveApi(data) {
  return request({
    url: `/admin/merchant/page/layout/bottom/navigation/save`,
    method: 'post',
    data
  });
}