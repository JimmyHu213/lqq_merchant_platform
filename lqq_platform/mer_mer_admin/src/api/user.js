...
/**
 * @description 商户用户购物金记录
 */
export function shoppingCreditsRecordApi(id) {
  return request({
    url: `/admin/merchant/user/shopping/credits/record/${id}`,
    method: 'get',
  });
}

/**
 * @description 商户用户购物金冻结-解冻
 */
export function shoppingCreditsFreezeApi(id) {
  return request({
    url: `/admin/merchant/user/shopping/credits/freeze/update/${id}`,
    method: 'post',
  });
}