      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.__vModel__ !== undefined" label="字段名">
            <el-input v-model.trim="activeData.__vModel__" placeholder="请输入字段名（v-model）" />
          </el-form-item>
          <el-form-item v-if="activeData.__config__.componentName !== undefined" label="组件名">
            {{ activeData.__config__.componentName }}
          </el-form-item>
          <el-form-item v-if="activeData.__config__.tag === 'self-upload'" label="标题">
            <el-input v-model.trim="activeData.__config__.label" placeholder="请输入标题" />
          </el-form-item>
          <el-form-item
          ...
          <el-form-item v-if="activeData.placeholder !== undefined" label="占位提示">
            <el-input v-model.trim="activeData.placeholder" placeholder="请输入占位提示" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.name !== undefined" label="文件字段名">
            <el-input v-model.trim="activeData.name" placeholder="请输入上传文件字段名" />
          </el-form-item>
          ...
          <template v-if="['el-cascader'].indexOf(activeData.__config__.tag) > -1">
            ...
            <template v-if="activeData.__config__.dataType === 'dynamic'">
              <el-form-item label="标签键名">
                <el-input v-model.trim="activeData.props.props.label" placeholder="请输入标签键名" />
              </el-form-item>
              <el-form-item label="值键名">
                <el-input v-model.trim="activeData.props.props.value" placeholder="请输入值键名" />
              </el-form-item>
              <el-form-item label="子级键名">
                <el-input v-model.trim="activeData.props.props.children" placeholder="请输入子级键名" />
              </el-form-item>
            </template>
