<template>
  <div>
    <el-tabs v-model="typeDate" @tab-click="radioChange" class="list-tabs">
      ...
      <el-tab-pane
        v-if="modelName !== 'diy' && modelName === 'imagesAndVideos'"
        label="视频"
        name="video"
      ></el-tab-pane>
    </el-tabs>
              ...
              >
                ...
                <el-table-column label="图片名称">
                  <template slot-scope="scope">
                    <div class="imgDiv">
                      <el-image
                        :src="scope.row.sattDir"
                        :preview-src-list="[scope.row.sattDir]"
                        alt=""
                        class="listImg"
                        v-if="typeDate == 'pic'"
                      />
...
export default {
  ...
  created() {
    ...
    if (checkPermi(['merchant:attachment:list'])) this.getFileListAsync();
  },
  mounted() {
    if (this.pictureType) {
