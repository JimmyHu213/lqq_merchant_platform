<template>
  <div class="divBox">
    ...
    >
      ...
      <el-table-column width="50" key="1" v-if="handleNum !== 'many'">
        <template slot-scope="scope">
          <el-radio v-model="templateRadio" @change.native="getTemplateRow(scope.row)"
            >&nbsp;</el-radio
          >
        </template>
      </el-table-column>
      ...
      <el-table-column prop="categoryName" label="商品分类" min-width="150" show-overflow-tooltip />
...
export default {
  ...
  methods: {
    ...
    getList(num) {
      ...
      productActivityListApi(this.tableFrom)
        .then((res) => {
