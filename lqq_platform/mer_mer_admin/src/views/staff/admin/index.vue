<template>
  <div class="divBox">
    ...
    <el-card class="mt14" :body-style="{ padding: '20px' }" shadow="never" :bordered="false">
      <el-button size="small" type="primary" @click="addStaff">添加人员</el-button>
      <el-table
        ref="table"
      ...
      >
        ...
        <el-table-column prop="creatTime" label="创建时间" min-width="120"> </el-table-column>
    ...
    <!-- 弹窗框 -->
    <el-dialog
      :title="editDialogConfig.isCreate === 0 ? `添加人员` : `编辑人员`"
...
export default {
  ...
  data() {
    return {
      roleArr: ['', '订单管理', '商品管理', '售后管理', '代客下单', '订单核销', '销量/用户统计', '工单管理'],
      listLoading: false,
      tableData: {
        data: [],
        total: 0,
