<template>
  <div>
    ...
    <!-- 统计数据 -->
    <div v-if="productStatisticsData.length && checkPermi(['merchant:product:statistics:top'])" class="mt14">
      <statistics-data-card-list :statisticsData="productStatisticsData"></statistics-data-card-list>
    </div>
    <!-- 统计图像 -->
    <div class="statistic-image-box">
      <!-- 商品折线图 -->
      <el-row class="mt14" v-if="checkPermi(['merchant:product:statistics:chart'])">
        <el-col :span="24">
      ...
      <el-row class="mt14" :gutter="14">
        <!-- 商品分类图 -->
        <el-col :span="12" v-if="checkPermi(['merchant:product:statistics:category'])">
        ...
        <!-- 商品类型图 -->
        <el-col :span="12" v-if="checkPermi(['merchant:product:statistics:type'])">
