    ...
    <el-card class="box-card mt14" shadow="never" :bordered="false">
      ...
      >
        ...
        <el-form-item label="身份类型：" required>
          <el-radio-group v-model="ruleForm.identityType" :disabled="$route.params.edit ? true : false">
            <el-radio :label="0">普通</el-radio>
            <el-radio :label="1">商户会员</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="优惠劵类别：" required>
        ...
        <el-form-item label="领取是否限时：" prop="isTimeReceive" required>
        ...
        <el-form-item label="领取时间：" v-if="ruleForm.isTimeReceive" class="required-star">
          <el-date-picker
            :disabled="$route.params.edit ? true : false"
        ...
        <el-form-item label="领取方式：" prop="receiveType" required>
          <el-radio-group v-model="ruleForm.receiveType" :disabled="$route.params.edit ? true : false">
            <el-radio :label="1">手动领取</el-radio>
            <el-radio v-show="ruleForm.identityType===0" :label="2">商品买赠券</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="是否限量：" prop="isLimited" required>
      ...
      couponInfoApi(this.$route.params.id)
        .then((res) => {
          ...
          this.ruleForm = {
            ...
            identityType: res.identityType ? res.identityType : 0
          };
