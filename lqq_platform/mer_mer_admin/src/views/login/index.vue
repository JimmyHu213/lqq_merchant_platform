...
import { accountDetectionApi, frontDomainApi, getSystemColorApi } from '@/api/authInformation';
  ...
  methods: {
    ...
    getMobileThemeColor() {
      getSystemColorApi().then((res) => {
        this.$store.commit('settings/SET_mobileThemeColor', res);
      });
    },
    //校验成功之后
