    ...
    <div id="store" class="diyStore" :style="boxStyle">
      ...
      <div class="text">
        ...
        <div class="merchantInfo flex">
          <div class="mr6 self_min merType" :style="{ backgroundColor: themeColor }">自营</div>
          ...
          <div class="score">
            <div class="starsList flex">
              <div v-for="(itemn, indexn) in JavaMerchantBaseInfo.starLevel" :key="indexn">
                <span class="iconfont icon-pingfen" :style="{ color: themeColor }"></span>
              </div>
...
export default {
  ...
  computed: {
    ...
    themeColor(){
      return this.$options.filters.filterTheme(this.mobileTheme - 1);
    },
    //最外层盒子的样式
    boxStyle() {
      return [
  ...
  data() {
    return {
      ...
      JavaMerchantConfigInfo: null, //商户头像、背景图信息
      noStarLevel: 0,
    };
  },
  mounted() {
