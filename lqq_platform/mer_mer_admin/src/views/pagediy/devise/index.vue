      ...
      <div class="acea-row">
        ...
        <div v-if="listActive === 0">
          <div class="rightModel acea-row">
            ...
            <div style="width: 100%">
              <el-row>
                <el-col v-bind="grid">
                  <div class="flex_between">
                    <el-button
                      v-hasPermi="[
                        'merchant:page:diy:update',
                        'merchant:page:diy:set:default',
                        'merchant:page:diy:info',
                      ]"
                      type="primary"
              ...
              <div class="mt-10 ml-60 width-300">
                <el-alert title="若页面未加载出，请联系平台配置网站域名" type="info"> </el-alert>
              </div>
            </div>
          </div>
        </div>
        <div v-else class="rightModel">
          <div slot="header" class="clearfix mb20">
            <div class="container" v-hasPermi="['merchant:page:diy:page']">
            ...
            <div class="flex">
              <el-button
                type="primary"
                v-hasPermi="['merchant:page:diy:save']"
              ...
              >
              <el-button
                v-hasPermi="['merchant:page:diy:page']"
                @click="getList(1)"
                size="small"
                style="font-size: 12px"
                >刷新</el-button
              >
              <div class="ml-14 width-350">
                <el-alert title="若预览页面未加载出，请联系平台配置网站域名" type="info"> </el-alert>
              </div>
            </div>
          </div>
          <el-table
          ...
          >
                ...
                <div class="acea-row row-middle">
                  ...
                  <el-input
                    ...
                    v-if="
                      ...
                      checkPermi(['merchant:page:diy:update:name'])
                    "
                  >
                  </el-input>
            ...
            <el-table-column label="操作" width="185" fixed="right">
              <template slot-scope="scope">
                <a
                  v-hasPermi="['merchant:page:diy:update', 'merchant:page:diy:info']"
                  @click="handlerEditDiyPage(scope.row.id, 'edit')"
                  >设计</a
                >
                <el-divider direction="vertical"></el-divider>
                <template v-if="scope.row.isDefault !== 1 && checkPermi(['merchant:page:diy:set:default'])">
                ...
                <el-dropdown trigger="click">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item
                      v-hasPermi="['merchant:page:diy:save', 'merchant:page:diy:info']"
                      @click.native="handlerEditDiyPage(scope.row.id, 'copy')"
                      >复制</el-dropdown-item
                    >
                    <el-dropdown-item
                      v-if="scope.row.isDefault !== 1 && checkPermi(['merchant:page:diy:delete'])"
...
export default {
  ...
  mounted() {
    ...
    this.frontDomain = `${this.$selfUtil.getFrontDomainUrl()}/pages/merchant/home/index?merId=${
      this.merchantId
    }&inner_frame=1&time=${time}`;
    if (checkPermi(['merchant:page:diy:page'])) this.getList();
  },
  methods: {
    checkPermi,
    ...
    getWechatQrcode() {
      ...
      wechatQrcodeApi({
        scene: 'id=0',
        path: `/pages/merchant/home/index?merId=${this.merchantId}`,
        env_version: 'release',
      }).then((res) => {
